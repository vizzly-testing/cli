...
const sections = [
  ...
  },
  {
    ...
    title: 'Conclusion',
    content:
      'Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat. Thank you for reading!',
  },
];
...
<template>
  <div class="page-long" data-test-page="long-page">
    ...
    <Alert @variant="info" @testId="scroll-notice">
      This page has content that extends beyond the viewport to test full-page
      screenshots.
    </Alert>
