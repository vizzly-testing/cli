/**
 * Task generation and processing for Storybook screenshots
 ...
 */
let defaultDeps = {
  getStoryConfig: defaultGetStoryConfig,
  generateStoryUrl: defaultGenerateStoryUrl,
...
export async function processAllTasks(tasks, pool, config, logger, deps = {}) {
  ...
  /**
   * Format story identifier for display
   */
  let formatStory = story => `${story.title}/${story.name}`;
