    ...
    <ComparisonContainer interactive={true} onClick={handleToggleDiff}>
      ...
      {showDiffOverlay &&
        ...
        imageErrors?.has(`diff-${screenshot?.id || 'unknown'}`) && (
          <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-[var(--accent-warning-muted)] border border-[var(--accent-warning-muted)] rounded-lg px-3 py-2 text-[var(--accent-warning)] text-sm backdrop-blur-sm">
