export function BaseComparisonMode({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: comparison panes delegate pointer interaction to the image viewer.
    // biome-ignore lint/a11y/useKeyWithClickEvents: keyboard shortcuts are handled at the viewer level.
