...
function Toast({ toast, onRemove }) {
  ...
  let bgColor =
    toast.type === 'success'
      ...
      : toast.type === 'confirm'
        ? 'bg-[var(--vz-raised)] border-[var(--vz-border)]'
  ...
  let isConfirm = toast.type === 'confirm';
                ...
                <button
                  ...
                  className={
                    action.variant === 'primary'
                      ? 'px-4 py-1.5 bg-[var(--accent-brand)] hover:bg-[var(--accent-brand-hover)] text-[var(--vz-bg)] text-sm font-medium rounded transition-colors'
                      : 'px-4 py-1.5 bg-[var(--vz-surface)] hover:bg-[var(--vz-elevated)] text-[var(--text-primary)] text-sm font-medium rounded transition-colors'
                  }
                >
                  {action.label}
                </button>
