    ...
    <div
      ...
      ${
        hasFailures
          ...
          : 'bg-[var(--accent-success-muted)] border-[color-mix(in_srgb,var(--accent-success)_28%,transparent)]'
      }
    `}
    >
      ...
      <div className="relative flex items-center gap-4 p-4">
        ...
        <div
          ...
          ${
            hasFailures
              ? 'bg-[var(--accent-danger-muted)] text-[var(--accent-danger)]'
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 flex-wrap">
            {failedCount > 0 && (
              <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-[var(--accent-danger-muted)] text-[var(--accent-danger)] text-sm font-medium">
                <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-danger)]" />
                {failedCount} changed
              </span>
            )}
            {newCount > 0 && (
              <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-[var(--accent-media-muted)] text-[var(--accent-media)] text-sm font-medium">
                <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-media)]" />
                {newCount} new
              </span>
            )}
          </div>
