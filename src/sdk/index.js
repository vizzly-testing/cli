 ...
 * For simple test runner usage, use @vizzly-test/cli/client instead.
 */

/**
 * @module @vizzly-test/cli/sdk
 ...
 * import { createVizzly } from '@vizzly-test/cli/sdk';
 *
...
export function createVizzly(config = {}, options = {}) {
  ...
  return {
    ...
    createLogger: loggerOptions => createLogger(loggerOptions),
